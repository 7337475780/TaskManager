...
const CreateTask = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (taskData.assignedTo?.length === 0) {
      setError("Assign task to someone");
      return;
    }

    if (taskData.todoCheckList?.length === 0) {
      setError("Add atleast one todo");
      return;
    }
      ...
      <div className="mt-5 ">
        <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            ...
            <div className="mt-4 ">
              <label className="tetxt-xs font-medium text-slate-600  ">
                Task Title
              </label>
              <input
                type="text"
                ...
                onChange={(target) =>
                  handleValueChange("title", target.target.value)
                }
              />
            </div>
            <div className="mt-3 ">
