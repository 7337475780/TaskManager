...
const TaskListTables = ({ tableData }) => {
  ...
  return (
    <div className="overflow-x-auto p-0 rounded-lg mt-3 ">
      <table className="min-w-full">
        ...
        <tbody>
          {tableData.map((data) => {
            <tr key={data._id} className="border-t border-gray-200 ">
              <td className="my-3 mx-4 tex-gray-700 text-[13px] line-clamp-1 overflow-hidden ">
                {data.title}
              </td>
