...
import TaskListTables from "../../components/layouts/TaskListTables.jsx";
...
const COLORS = ["#8D51FF", "#00BDBD", "#7BCE00"];
...
const DashBoard = () => {
  ...
  const getDashboardData = async () => {
    try {
      const response = axiosInstance.get(API_PATHS.TASKS.GET_DASHBOARD_DATA);
